...
public class US_027_TC_06 extends AdminTestBaseRapor {
    AdminDashboard adminDashboard = new AdminDashboard();
    @Test
    public void tc_06(){
        extentTest = extentReports.createTest("Tripandway admin panel testi",
                "Kullanici Language ulasabilmeli");
        // 1- Launch Browser
        ...
        // 7- Admin sayfasinda "Language" gorunurlugu dogrulanır
        Assert.assertTrue(adminDashboard.languageElementi.isDisplayed());
        extentTest.pass("Language elementi gorunurlugu test edildi");
    }
}
