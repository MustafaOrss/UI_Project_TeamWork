...
public class US_032_TC_03 extends AdminTestBaseRapor {
    ...
    Assert.assertTrue(adminDashboard.seeDetailButtonu.isDisplayed());
    extentTest.pass("See detail görünürlüğü dogrulandi");
}
