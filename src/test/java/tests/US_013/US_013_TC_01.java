...
public class US_013_TC_01 extends UserTestBaseRapor {
    UserHomepage userHomepage = new UserHomepage();

    @Test
    public void tc_01() {
        extentTest = extentReports.createTest("Tripandway anasayfaya gidiş, Destinations'a giriş testi",
                "Kullanici anasayfaya ulasabilmeli, Destinitaions'a tiklayabilmeli");
