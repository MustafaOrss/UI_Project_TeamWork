...
public class US_008_TC_04 extends UserTestBaseRapor {
    ...
    public void tc_04(){
        ...
        Assert.assertTrue(userHomepage.footerTelefonElementi.isDisplayed());
        extentTest.pass("Footer'da telefon bulundu");
    }
}
