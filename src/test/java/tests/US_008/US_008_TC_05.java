...
public class US_008_TC_05 extends UserTestBaseRapor {
    ...
    public void tc_05(){
        ...
        Assert.assertTrue(userHomepage.footerEmailElementi.isDisplayed());
        extentTest.pass("Footer'da email bulundu");
    }
}
