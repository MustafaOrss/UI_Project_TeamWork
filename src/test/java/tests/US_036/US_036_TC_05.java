...
public class US_036_TC_05 extends AdminTestBaseRapor {
    ...
    public void TC_05() throws InterruptedException, IOException {
        extentTest = extentReports.createTest("E-posta Formunun simule edilebilmesi.",
                "Kullanici E-posta formunu simule edebilmeli.");
