...
public class US_036_TC_07 extends AdminTestBaseRapor {
    ...
    public void TC_07() throws InterruptedException, IOException {
        extentTest = extentReports.createTest("Butun Haber listesi uyelerine E-posta gonderiminin dogrulanmasi",
                "Kullanici butun uyelere e-posta gonderildigini dogrulayabilmeli.");
        ...
        //14-E-posta gonderildigini dogrulamaliyim
        adminDashboard.emailSentSuccessfully.isDisplayed();
        extentTest.info("E-posta'nin basarili bir sekilde gonderildigi dogrulandi");
