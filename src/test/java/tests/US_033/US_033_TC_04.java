...
public class US_033_TC_04 extends AdminTestBaseRapor {
    ...
    public void tc_04(){
        ...
        //9-See Detail buttonuna tıklanır
        adminDashboard.seeDetailButtonu.click();
        extentTest.pass("See detail tıklandığı dogrulandi");
        ReusableMethods.wait(2);
        //10-Traveller Details görünür olduğu doğrulanır
        // Assert.assertTrue(adminDashboard.travellerDetailsButtonu.isDisplayed());
        extentTest.pass("Travellers Details görünür olduğu dogrulandi");
    }
